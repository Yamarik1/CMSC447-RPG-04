...
urlpatterns = [
    ...
    path('course/<int:course_id>/mainquest/<int:quest_id>/gainHearts', views.mainGainHearts, name='mainGainHearts'),
    path('course/<int:course_id>/mainquest/<int:pk>/quest/', views.mQuestSpecific.as_view(), name="mQuest"),
    path('course/<int:course_id>/mainquest/<int:quest_id>/quest/getAnswer', views.mainAutomaticAnswer, name="mAA"),
    path('course/<int:course_id>/mainquest/<int:quest_id>/quest/bombChoice', views.mainBombChoice, name="mBC"),
    ...
    path('course/<int:course_id>/mainquest/<int:quest_id>/summary/mXPBoost', views.mXPBoost, name="mXPBoost"),
    ...
    path('course/<int:course_id>/sidequest/<int:sidequest_id>/squest/getAnswer', views.sideAutomaticAnswer, name="sAA"),
    path('course/<int:course_id>/sidequest/<int:sidequest_id>/squest/bombChoice', views.sideBombChoice, name="sBC"),
    path('course/<int:course_id>/mainquest/<int:sidequest_id>/summary/sXPBoost', views.sXPBoost, name="sXPBoost"),
    ...
    path('course/<int:course_id>/sidequest/<int:sidequest_id>/gainHearts', views.sideGainHearts, name='sideGainHearts'),
